                        ...
                        <form action="../../process/add/add-user.php" method="POST">
                            <div class="p-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="role" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40">

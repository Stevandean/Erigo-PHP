            ...
            <div class="space-y-10 xl:px-10">
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-x-28 space-y-7 xl:space-y-4">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <div class="flex border py-1.5 px-3 rounded-md space-x-3">
                            <svg width="30" height="30" viewBox="0 0 70 70" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11.666 20.4168L29.7493 33.9792C32.8606 36.3125 37.1381 36.3125 40.2493 33.9792L58.3327 20.4167"
                                    stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    d="M55.4167 14.5833H14.5833C11.3617 14.5833 8.75 17.195 8.75 20.4167V49.5833C8.75 52.805 11.3617 55.4167 14.5833 55.4167H55.4167C58.6383 55.4167 61.25 52.805 61.25 49.5833V20.4167C61.25 17.195 58.6383 14.5833 55.4167 14.5833Z"
                                    stroke="black" stroke-width="3" stroke-linecap="round" />
                            </svg>
                            <input type="text" name="" id="" placeholder="ainu.azaria@gmail.com"
                                class="px-2 focus:outline-none w-full">
                        </div>
                    </div>
                    <div class="flex flex-col justify-center xl:col-span-2">
                        ...
                        <div class="flex border py-1.5 px-3 rounded-md space-x-3">
                            <svg width="30" height="30" viewBox="0 0 44 60" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M21.9922 -0.0078125C9.8656 -0.0078125 -0.00585408 9.86368 -0.00585937 21.9902C-0.00586693 43.3277 20.752 59.5493 20.752 59.5493C21.1064 59.832 21.5462 59.986 21.9996 59.986C22.4529 59.986 22.8927 59.832 23.2471 59.5493C23.2471 59.5493 44.005 43.3277 44.005 21.9902C44.0049 9.86368 34.1187 -0.0078125 21.9922 -0.0078125ZM21.9922 3.99317C31.957 3.99317 40.004 12.0254 40.004 21.9902C40.004 39.446 24.1975 53.2374 22.0069 55.1054C19.8268 53.2468 3.99512 39.4528 3.99512 21.9902C3.99513 12.0254 12.0274 3.99317 21.9922 3.99317Z"
                                    fill="black" />
                                <path
                                    d="M21.9931 11.9951C16.494 11.9951 11.9981 16.4911 11.998 21.9902C11.998 27.4894 16.4939 32 21.9931 32C27.4923 32 32.003 27.4894 32.003 21.9902C32.003 16.4911 27.4923 11.9951 21.9931 11.9951ZM21.9931 15.9961C25.3305 15.9961 28.002 18.6528 28.002 21.9902C28.002 25.3276 25.3305 27.9991 21.9931 27.9991C18.6557 27.9991 15.999 25.3276 15.999 21.9902C15.999 18.6528 18.6557 15.9961 21.9931 15.9961Z"
                                    fill="black" />
                            </svg>
                            <input type="text" name="" id=""
                                placeholder="Gang Mirej 01 No. 84, Madyopuro, Kedungkandang, Jawa Timur, 65139"
                                class="px-2 focus:outline-none w-full">
                        </div>
                    </div>
                </div>

    ...
    <div class="flex font-[Poppins]">
        ...
        <main class="w-full h-screen bg-slate-100">
            ...
            <section>
                ...
                $sql = "SELECT id, product_name, price, `desc`, stock, pict, categories_id FROM product WHERE id='" . $_GET['id'] . "'";
                ...
                ?>
                <div
                    class="max-w-7xl mx-auto mt-2 rounded-md bg-white px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1">
                        ...
                        <form>
                            <div class="p-6">
                                <div class="mb-6">
                                    ...
                                    <input type="file" name="pict" id="pict" value="<?php echo $row['pict'] ?>"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40" />
                                </div>
                                <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="desc" id="desc" value="<?php echo $row['desc'] ?>"
                                        placeholder="Enter description product"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40"></textarea>
                                </div>
                                <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="categories_id" value="<?php echo $row['categories_id'] ?>"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40">
                                        <?php
                                ...
                                <button type="submit"
                                    class="flex w-full justify-center rounded bg-navy p-3 font-medium text-white hover:bg-navy/90">
                                    Save
                                </button>
                            </div>
                        </form>

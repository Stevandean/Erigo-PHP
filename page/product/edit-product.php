...
<head>
    <?php SEO("Edit Product | Admin Panel"); ?>
</head>
    ...
    <div class="flex font-[Poppins]">
        ...
        <main class="w-full h-screen bg-slate-100">
            ...
            <section>
                ...
                $sql = "SELECT id, product_name, price, `desc`, stock, categories_id FROM product WHERE id='" . $_GET['id'] . "'";
                ...
                <div class="max-w-7xl mx-auto mt-2 rounded-md bg-white px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1">
                    ...
                    <div class="container justify-center w-full mb-6 rounded-md">
                        <form action="../../process/edit/edit-product.php" method="POST" enctype="multipart/form-data">
                            <div class="p-6">
                                <div class="mb-6">
                                    <label for="pict" class="mb-3 block text-sm font-medium text-black">
                                        Photo Product
                                    </label>
                                    <input type="file" accept="image/*" name="pict" id="pict" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40" />
                                </div>
                                <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input name="desc" id="desc" value="<?php echo $row['desc'] ?>" placeholder="Enter description product" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-navy/40"></input>
                                </div>
                                <div class="mb-6">

...
<body>
    <main class="bg-[#F9FAFB] w-full min-h-screen flex items-center justify-center font-[Poppins]">
        <section class="bg-white max-w-lg mx-auto rounded-2xl p-[50px] w-5/6 xl:w-full">
            ...
            <!-- Form Data -->
            <form action="../../process/auth/auth-login-admin.php" method="POST" class="mt-[20px]">
                ...
                <div class="flex flex-col items-start mb-[20px]">
                    <div class="flex items-center justify-between mb-2 w-full">
                        ...
                        <a href="../member/not-found.php" class="font-['Poppins'] font-medium text-sm text-blue-500 hover:text-blue-600 transition-all duration-250 ease-linear">Forgot Password?</a>
                    </div>

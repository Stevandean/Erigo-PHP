...
<body>
    <main class="min-h-screen bg-navy flex flex-col justify-center items-center">
        <section class="relative bg-white rounded-xl px-5 py-6 xl:w-full max-w-screen-lg w-full mt-10 mx-auto" style="align-self: flex-start;">
            <h1 class="text-[17px] font-bold ml-4 uppercase">Your Purchase</h1>
        ...
        <section class="container flex flex-col items-center justify-center mx-auto my-[50px]">
            <div class="flex items-center justify-center gap-14">
                <h3 class="text-xl font-medium text-white">Silakan selesaikan pembayaran Anda dalam</h3>
                <span class="text-xl font-medium text-white">0:15:09</span>
            </div>

...
if ($_POST) {
    ...
    if (empty($email)) {
        ...
        $qry = mysqli_query($conn, "select * from user where email = '" . $email . "' and password = '" . $hashed_password . "'");
...
//         echo "<script>alert('Password field can\\'t empty! Please fill Password field!'); location.href='../../login.php';</script>";
//     } else {
//         $qry = mysqli_query($conn, "select * from user where email = '" . $email . "' and password = '" . md5($password) . "'");

    ...
    <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
      <div>
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a href="../admin/dashboard.php" class="text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-semibold duration-300 ease-in-out hover:bg-white dark:hover:bg-blue-900">
          ...
          <li>
            <a href="../admin/categories.php" class="text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-semibold duration-300 ease-in-out hover:bg-white dark:hover:bg-blue-900">
          ...
          <li>
            <a href="../admin/product.php" class="text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-semibold duration-300 ease-in-out hover:bg-white dark:hover:bg-blue-900">
          ...
          <li>
            <a href="../admin/users.php" class="text-white group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-semibold duration-300 ease-in-out hover:bg-white dark:hover:bg-blue-900">
              <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
